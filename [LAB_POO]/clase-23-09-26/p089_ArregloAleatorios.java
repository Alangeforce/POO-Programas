...
public class p089_ArregloAleatorios {
    ...
    static void Mostrar(ArrayList<Float> nums) {
        for (float n : nums) System.out.printf("%.2f ", n);
        System.out.println();
    }

    static void GeneraAleatorio(ArrayList<Float> nums, int cantidad) {
    ...
    static void SumaListas(ArrayList<Float> a1, ArrayList<Float> a2, ArrayList<Float> a3) {
